      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/st.jpg" alt="Stitch Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/bill.jpg" alt="Bill Nye Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/fork.jpg" alt="Forky Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/jp2.jpg" alt="Winifred Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/hp1.jpg" alt="Mary Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/hp3.jpg" alt="Sarah Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/fro.jpg" alt="Frozone Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/jh.jpg" alt="Jim Henson Funko Pop">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card shadow-sm pt-1">
            ...
            <img src="../../images/al.jpg" alt="Alien Funko Pop">
            <div class="card-body">
