      ...
      <div class="card col-md-6 offset-md-3 p-3">
                ...
                <?php
                    foreach ($reviews as $rev)
                        ...
                        <li><button type='submit' id='special' title='Edit Review' class='text-norwap'><b>$showname</b> - $review <i class='bi bi-pencil-fill'> </i></button></li>
                        <input type='hidden' id='accountid' name='accountid' value='$accid'>
                ...
                <?php 
                    ...
                    if (isset ($_SESSION['userlevel']) && $_SESSION['userlevel'] == 3){
                        ...
                        foreach ($suggestion as $sug){
                            ...
                            <li><button type='submit' id='special' class='text-norwap' title='Add Suggestion To Database'><b> $sname</b> - $desc <i class='bi bi-check2-square'> </i></button></li>
